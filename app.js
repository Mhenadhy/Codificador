...
function descriptografar(){
    ...
    document.getElementById('out-input').innerHTML = '<section id="out-input">' + resulDescripto + '<button class="btn-copiar" onclick="copytext()">Copiar</button>' + '</section>' + '</section>';
}

function copytext(){
    navigator.clipboard.writeText(out-input.value).then(() => {
